        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('coordinator.events.store') }}" enctype="multipart/form-data" class="space-y-6 max-w-4xl">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="category" name="category" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="Competition" @selected(old('category') == 'Competition')>Competition</option>
                            ...
                            <div>
                                ...
                                <x-text-input id="capacity_limit" class="block mt-1 w-full" type="number" name="capacity_limit" :value="old('capacity_limit')" min="1" required />
